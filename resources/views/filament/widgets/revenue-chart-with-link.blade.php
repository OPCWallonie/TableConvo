...
<x-filament-widgets::widget class="fi-wi-chart">
    ...
    <div style="padding: 0.5rem 1rem 0.25rem; text-align: right; border-top: 1px solid rgba(0,0,0,0.06);">
        <a href="{{ $this->getDrillDownUrl() }}"
           style="font-size: 0.8125rem; font-weight: 500; color: rgb(16 185 129); text-decoration: none;">
            Voir le détail →
        </a>
    </div>
